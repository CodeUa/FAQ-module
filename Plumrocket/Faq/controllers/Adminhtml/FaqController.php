...
class Plumrocket_Faq_Adminhtml_FaqController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->loadLayout()->_setActiveMenu('plumrocket_faq');
        $this->_addContent($this->getLayout()->createBlock('plumrocket_faq/adminhtml_faq'));
        $this->renderLayout();
    }
        ...
        public function editAction()
    {
        ...
        Mage::register('current_faq', Mage::getModel('plumrocket_faq/faq')->load($id));

        $this->loadLayout()->_setActiveMenu('plumrocket_faq');
        $this->_addContent($this->getLayout()->createBlock('plumrocket_faq/adminhtml_faq_edit'));
        $this->renderLayout();
    }
        ...
        public function deleteAction()
    {
        if ($id = $this->getRequest()->getParam('id')) {
            try {
                Mage::getModel('plumrocket_faq/faq')->setId($id)->delete();
    ...
    {
        $news = $this->getRequest()->getParam('faq', null);
